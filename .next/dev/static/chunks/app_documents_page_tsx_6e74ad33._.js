...
function HighlightDiffText({ oldText = "", newText = "" }) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: oldWords.map((word, i)=>{
            const isChanged = !newSet.has(word.toLowerCase());
            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                className: isChanged ? "bg-red-100 text-red-900 px-1 py-0.5 rounded line-through font-bold" : "",
                children: word
            }, i, false, {
                fileName: "[project]/app/documents/page.tsx",
                lineNumber: 101,
...
_c1 = HighlightDiffText;
// Function to highlight only changed parts in new text
function HighlightDiffTextNew({ oldText = "", newText = "" }) {
    const oldWords = (oldText || "").split(/(\s+)/);
    const newWords = (newText || "").split(/(\s+)/);
    const oldSet = new Set(oldWords.map((w)=>w.toLowerCase()));
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "text-sm text-gray-700",
        children: newWords.map((word, i)=>{
            const isChanged = !oldSet.has(word.toLowerCase());
            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                className: isChanged ? "bg-emerald-100 text-emerald-900 px-1 py-0.5 rounded font-bold" : "",
                children: word
            }, i, false, {
                fileName: "[project]/app/documents/page.tsx",
                lineNumber: 130,
...
function DocumentsPage() {
    ...
    const [sort, setSort] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("UPDATED_DESC");
    ...
    const computed = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "DocumentsPage.useMemo[computed]": ()=>{
            const list = [
                ...items
            ].sort({
                "DocumentsPage.useMemo[computed].list": (a, b)=>new Date(b.created_at).getTime() - new Date(a.created_at).getTime()
            }["DocumentsPage.useMemo[computed].list"]);
            const byDoc = new Map();
            for (const x of list){
            ...
            const rows = [
                ...
                "DocumentsPage.useMemo[computed].rows": (x)=>({
                        doc: x.doc,
            ...
            }["DocumentsPage.useMemo[computed].rows"]);
            // filters
            const qq = q.trim().toLowerCase();
            let filtered = rows.filter({
                "DocumentsPage.useMemo[computed].filtered": (r)=>{
                    const okQ = !qq ? true : r.doc.toLowerCase().includes(qq);
                    const okRisk = riskFilter === "ALL" ? true : r.lastRisk === riskFilter;
                    return okQ && okRisk;
                }
            }["DocumentsPage.useMemo[computed].filtered"]);
            // sort
            const riskScore = {
                "DocumentsPage.useMemo[computed].riskScore": (r)=>r === "HIGH" ? 3 : r === "MEDIUM" ? 2 : 1
            }["DocumentsPage.useMemo[computed].riskScore"];
            filtered.sort({
                "DocumentsPage.useMemo[computed]": (a, b)=>{
            ...
            const totalVersionsEstimated = rows.reduce({
                "DocumentsPage.useMemo[computed].totalVersionsEstimated": (s, r)=>s + r.versionsEstimated
            }["DocumentsPage.useMemo[computed].totalVersionsEstimated"], 0);
            const highDocs = rows.filter({
                "DocumentsPage.useMemo[computed]": (r)=>r.lastRisk === "HIGH"
            }["DocumentsPage.useMemo[computed]"]).length;
            const medDocs = rows.filter({
                "DocumentsPage.useMemo[computed]": (r)=>r.lastRisk === "MEDIUM"
            }["DocumentsPage.useMemo[computed]"]).length;
            const lowDocs = rows.filter({
                "DocumentsPage.useMemo[computed]": (r)=>r.lastRisk === "LOW"
            }["DocumentsPage.useMemo[computed]"]).length;
            // top changes
            const topChanged = [
                ...rows
            ].sort({
                "DocumentsPage.useMemo[computed].topChanged": (a, b)=>b.totalChanges - a.totalChanges
            }["DocumentsPage.useMemo[computed].topChanged"]).slice(0, 5);
            const maxChanges = Math.max(1, ...topChanged.map({
                "DocumentsPage.useMemo[computed].maxChanges": (x)=>x.totalChanges
            }["DocumentsPage.useMemo[computed].maxChanges"]));
            // Get selected document details
            const selectedDocDetails = selectedDoc ? rows.find({
                "DocumentsPage.useMemo[computed]": (r)=>r.doc === selectedDoc
            }["DocumentsPage.useMemo[computed]"]) : null;
            return {
                rows,
                filtered,
                totalDocs,
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                ...
                                                children: "ดูเอกสารทั้งหมดที่เคยเปรียบเทียบ จัดกลุ่มตามชื่อเอกสาร"
                                            }, void 0, false, {
                                                fileName: "[project]/app/documents/page.tsx",
                                                lineNumber: 366,
                                                columnNumber: 17
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                className: "text-2xl font-bold text-gray-900",
                                                children: computed.totalComparisons
                                            }, void 0, false, {
                                                fileName: "[project]/app/documents/page.tsx",
                                                lineNumber: 434,
                                                columnNumber: 17
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                className: "text-2xl font-bold text-gray-900",
                                                children: computed.totalVersionsEstimated
                                            }, void 0, false, {
                                                fileName: "[project]/app/documents/page.tsx",
                                                lineNumber: 446,
                                                columnNumber: 17
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$heroicons$2f$react$2f$24$2f$outline$2f$esm$2f$ArchiveBoxIcon$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__ArchiveBoxIcon$3e$__["ArchiveBoxIcon"], {
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                className: "text-2xl font-bold text-gray-900",
                                                children: computed.riskSummary.highDocs
                                            }, void 0, false, {
                                                fileName: "[project]/app/documents/page.tsx",
                                                lineNumber: 458,
                                                columnNumber: 17
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            lineNumber: 538,
                                            columnNumber: 17
                                        }, this) : computed.filtered.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "p-8 text-center",
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                className: "text-gray-600",
                                                children: "ไม่พบเอกสารที่ตรงกับการค้นหา"
                                            }, void 0, false, {
                                                fileName: "[project]/app/documents/page.tsx",
                                                lineNumber: 544,
                                                columnNumber: 19
                                            ...
                                            children: computed.filtered.slice(0, 20).map((doc)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: `p-4 hover:bg-gray-50 cursor-pointer transition-colors ${selectedDoc === doc.doc ? "bg-blue-50 border-l-4 border-blue-500" : ""}`,
                                                        ...
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                ...
                                                                children: [
                                                                    ...
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                        className: "flex flex-wrap items-center gap-2 text-sm text-gray-600 mb-3",
                                                                        children: [
                                                                            ...
                                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                                className: "font-bold text-gray-900",
                                                                                children: [
                                                                                    doc.totalChanges.toLocaleString(),
                                                                                    " การเปลี่ยนแปลง"
                                                                                ]
                                                                            }, void 0, true, {
                                                                                fileName: "[project]/app/documents/page.tsx",
                                                                    ...
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                        ...
                                                                        children: [
                                                                            "อัพเดตล่าสุด: ",
                                                                            formatDateShort(doc.lastUpdatedISO)
                                                                        ]
                                                                    }, void 0, true, {
                                                                        fileName: "[project]/app/documents/page.tsx",
                                                                        lineNumber: 575,
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                className: "flex items-center gap-2",
                                                                children: doc.lastComparisonId && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "space-y-6",
                            children: [
                                computed.selectedDocDetails ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "bg-white rounded-xl border border-gray-200 overflow-hidden",
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "p-4 border-b border-gray-200",
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                                                    ...
                                                    children: computed.selectedDocDetails.doc
                                                }, void 0, false, {
                                                    fileName: "[project]/app/documents/page.tsx",
                                                    lineNumber: 609,
                                                    columnNumber: 19
                                                    ...
                                                    children: [
                                                            ...
                                                            children: [
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    children: [
                                                                        ...
                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                            ...
                                                                            children: computed.selectedDocDetails.comparisons
                                                                        }, void 0, false, {
                                                                            fileName: "[project]/app/documents/page.tsx",
                                                                            lineNumber: 617,
                                                                            columnNumber: 25
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    children: [
                                                                        ...
                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                            className: "text-xl font-bold text-gray-900",
                                                                            children: computed.selectedDocDetails.totalChanges.toLocaleString()
                                                                        }, void 0, false, {
                                                                            fileName: "[project]/app/documents/page.tsx",
                                                                            lineNumber: 623,
                                                                            columnNumber: 25
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            children: [
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    className: "text-sm font-medium text-gray-900 bg-gray-50 p-3 rounded-lg",
                                                                    children: computed.selectedDocDetails.lastFromTo
                                                                }, void 0, false, {
                                                                    fileName: "[project]/app/documents/page.tsx",
                                                                    lineNumber: 631,
                                                                    columnNumber: 23
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            children: [
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    className: "text-sm text-gray-600 mb-2",
                                                                    children: "การเปรียบเทียบทั้งหมด"
                                                                }, void 0, false, {
                                                                    fileName: "[project]/app/documents/page.tsx",
                                                                    lineNumber: 637,
                                                                    columnNumber: 23
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    ...
                                                                    children: computed.selectedDocDetails.allComparisons.sort((a, b)=>new Date(b.created_at).getTime() - new Date(a.created_at).getTime()).slice(0, 5).map((comp)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                                                            ...
                                                                            children: [
                                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                                    ...
                                                                                    children: [
                                                                                        comp.version_old_label,
                                                                                        " → ",
                                                                                        comp.version_new_label
                                                                                    ]
                                                                                }, void 0, true, {
                                                                                    fileName: "[project]/app/documents/page.tsx",
                                                                                    lineNumber: 648,
                                                                                ...
                                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                                    ...
                                                                                    children: formatDateShort(comp.created_at)
                                                                                }, void 0, false, {
                                                                                    fileName: "[project]/app/documents/page.tsx",
                                                                                    lineNumber: 649,
                                                                                    columnNumber: 31
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            ...
                                            children: "คลิกรายการเอกสารเพื่อดูรายละเอียด"
                                        }, void 0, false, {
                                            fileName: "[project]/app/documents/page.tsx",
                                            lineNumber: 668,
                                            columnNumber: 17
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                                                className: "font-bold text-gray-900",
                                                children: "เอกสารที่มีการเปลี่ยนแปลงมากที่สุด"
                                            }, void 0, false, {
                                                fileName: "[project]/app/documents/page.tsx",
                                                lineNumber: 675,
                                                columnNumber: 17
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "divide-y divide-gray-200",
                                            children: computed.topChanged.map((doc, index)=>{
                                                ...
                                                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        ...
                                                        doc.lastComparisonId && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            className: "mt-3",
                                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                                                href: `/compare/${doc.lastComparisonId}`,
                                                                className: "text-sm text-blue-600 hover:text-blue-800 font-medium",
                                                                children: "ดูการเปรียบเทียบล่าสุด →"
                                                            }, void 0, false, {
                                                                fileName: "[project]/app/documents/page.tsx",
                                                                lineNumber: 704,
                                                                columnNumber: 27
...
_s(DocumentsPage, "vgHB9pF/2TSZQaBloTSdBLhKh+Q=");
_c3 = DocumentsPage;
var _c, _c1, _c2, _c3;
__turbopack_context__.k.register(_c, "RiskPill");
__turbopack_context__.k.register(_c1, "HighlightDiffText");
__turbopack_context__.k.register(_c2, "HighlightDiffTextNew");
__turbopack_context__.k.register(_c3, "DocumentsPage");
