...
/* ---------------- utils ---------------- */ function normalizeRisk(r) {
...
/* ---------------- UI ---------------- */ function RiskBadge({ r }) {
    ...
    if (r === "MEDIUM") return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
        className: "rounded-full bg-yellow-100 px-2 py-0.5 text-xs font-bold text-yellow-700",
        children: "MEDIUM"
    }, void 0, false, {
        fileName: "[project]/app/reports/page.tsx",
        lineNumber: 72,
...
function ReportsPage() {
    ...
    const [monthKey, setMonthKey] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(formatMonthKey(new Date()));
    const [docFilter, setDocFilter] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("ALL");
    ...
    const fetchData = async ()=>{
        ...
        setError(null);
        try {
            const res = await fetch(`${API_BASE}/comparisons?limit=200`, {
                cache: "no-store"
            });
    ...
    const computed = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ReportsPage.useMemo[computed]": ()=>{
            const list = [
                ...items
            ].sort({
                "ReportsPage.useMemo[computed].list": (a, b)=>+new Date(b.created_at) - +new Date(a.created_at)
            }["ReportsPage.useMemo[computed].list"]);
            const months = Array.from(new Set(list.map({
                "ReportsPage.useMemo[computed].months": (x)=>formatMonthKey(new Date(x.created_at))
            }["ReportsPage.useMemo[computed].months"]))).sort({
                "ReportsPage.useMemo[computed].months": (a, b)=>a < b ? 1 : -1
            }["ReportsPage.useMemo[computed].months"]);
            const monthItems = list.filter({
                "ReportsPage.useMemo[computed].monthItems": (x)=>formatMonthKey(new Date(x.created_at)) === monthKey
            }["ReportsPage.useMemo[computed].monthItems"]);
            const docs = [
                "ALL",
                ...Array.from(new Set(monthItems.map({
                    "ReportsPage.useMemo[computed]": (x)=>x.document_name
                }["ReportsPage.useMemo[computed]"])))
            ];
            const filtered = monthItems.filter({
                "ReportsPage.useMemo[computed].filtered": (x)=>{
                    if (docFilter !== "ALL" && x.document_name !== docFilter) return false;
                    if (riskFilter !== "ALL" && normalizeRisk(x.overall_risk_level) !== riskFilter) return false;
                    return true;
                }
            }["ReportsPage.useMemo[computed].filtered"]);
            return {
                months,
                docs,
                filtered
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "min-h-screen bg-slate-100 py-6",
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    onClick: fetchData,
                                    className: "inline-flex items-center gap-2 rounded-full bg-blue-600 px-4 py-2 text-sm font-bold text-white hover:bg-blue-700",
                                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                    ...
                                    children: computed.months.map((m)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                            value: m,
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                    ...
                                    className: "rounded-xl border px-3 py-2 text-sm",
                                    children: computed.docs.map((d)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                            value: d,
                ...
                loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    lineNumber: 230,
                    columnNumber: 11
                }, this) : computed.filtered.map((x)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "rounded-2xl bg-white p-4 shadow-sm",
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(RiskBadge, {
                                                    r: normalizeRisk(x.overall_risk_level)
                                                }, void 0, false, {
                                                    fileName: "[project]/app/reports/page.tsx",
                                                    lineNumber: 245,
                                                    columnNumber: 21
...
_s(ReportsPage, "L9tKQpgvfPQur+b+g8iFskSVmp8=");
_c1 = ReportsPage;
var _c, _c1;
...
//# sourceMappingURL=_c11bb8ba._.js.map